...
echo 9. 🧑‍💼 Operador - validar_deposito.feature
behave features\Comision\Operador\validar_deposito.feature --tags ~@omitir --no-capture
if errorlevel 1 (
...
echo 10. 🧑‍💼 Autorizador - conciliar.feature
behave features\Comision\Autorizador_SIGEVI\conciliar.feature --tags ~@omitir --no-capture
if errorlevel 1 (
    echo ❌ ERROR en Paso 10 - Deteniendo ejecucion
    pause
    exit /b 1
)
